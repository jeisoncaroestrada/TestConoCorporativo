...
export class UserProfileService {
    ...
    private modalProductSubject = new Subject<any>();
    ...
    /* ---------------------- ABRE Y CIERRA EL MODAL EDITAR PASSWORD --------------------------------------*/
    setModalProduct(modalProduct: boolean) {
        this.modalProductSubject.next(modalProduct);
    }

    getModalProduct(): Observable<any> {
        return this.modalProductSubject.asObservable();
    }
